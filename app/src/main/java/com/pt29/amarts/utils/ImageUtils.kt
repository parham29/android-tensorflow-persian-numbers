package com.pt29.amarts.utils

import android.graphics.Bitmap
import android.graphics.Canvas
import android.graphics.Matrix
import com.pt29.amarts.classifier.IMAGE_SIZE
...
fun getCroppedBitmapLarge(bitmap: Bitmap): Bitmap {
    val croppedBitmap = Bitmap.createBitmap(1000, 1000, Bitmap.Config.ARGB_8888)
    val transformationMatrix = getPhotoBitmapTransformationMatrix(bitmap)
    val canvas = Canvas(croppedBitmap)
    canvas.drawBitmap(bitmap, transformationMatrix, null)
    return croppedBitmap
